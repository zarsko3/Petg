...
import { Loader2, Dog, Shield, Heart } from 'lucide-react';
        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700 text-white p-8 lg:p-12 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Welcome Back to<br />Smart Pet Care
            </h2>
            <p className="text-xl text-blue-100 mb-12 leading-relaxed">
              Continue monitoring your pets and accessing your personalized dashboard with real-time updates.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Your account and pet data are protected with enterprise-grade security</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Real-time monitoring and instant alerts about your pet's well-being</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Track health, location, activity, and more from one unified platform</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            <Card className="border-0 shadow-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
              <CardHeader className="space-y-1 text-center">
                ...
                <CardDescription>
                  Sign in to your PETg account to monitor your pets
                </CardDescription>
              </CardHeader>
                ...
                {isClerkAvailable ? (
                  <div className="space-y-4">
                    <SignIn
                      appearance={{
                        elements: {
                          formButtonPrimary: 'bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-sm normal-case font-medium transition-all duration-200 shadow-lg hover:shadow-xl',
                          card: 'bg-transparent shadow-none p-0 border-0',
                          headerTitle: 'hidden',
                          headerSubtitle: 'hidden',
                          footerAction: 'hidden',
                          formFieldInput: 'border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 rounded-xl px-4 py-3',
              ...
              <CardFooter className="flex flex-col space-y-4">
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link
                    href={isClerkAvailable ? "/signup" : "/signup"}
